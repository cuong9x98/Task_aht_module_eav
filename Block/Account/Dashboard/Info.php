 ...
 */
namespace AHT\Eav\Block\Account\Dashboard;
...
class Info extends \Magento\Framework\View\Element\Template
{
    ...
    public function getPhonenumber()
    {
        ...
        return ($customer->getCustomAttribute('phone_add')->getValue());
    }
    public function getAvatar()
    {
        $id = $this->customerSession->getCustomer()->getId();
        $customer =$this->customerRepositoryInterface->getById($id);
        return ($customer->getCustomAttribute('customer_image')->getValue());
    }
}
